...
namespace Softcam
{
    ...
    internal sealed class NativeMethods
    {
        ...
        /// <summary>
        /// ایجاد یک مستطیل با گوشه های گرد
        /// </summary>
        internal abstract class RoundedRectangle
        {
            ...
            public static GraphicsPath Create(Rectangle rect, int radius, Corners c)
            {
        ...
        /// <summary>
        /// کلاس زبانهای سیستم جهت استفاده در توابع تغییر زبان صفحه کلید
        /// </summary>
        public sealed class Language
        {
            ...
            /// زبان عربی عمومی
            /// </summary>
            public const string LANG_Ar_As = "00000401";
            public const string LANG_DU_STD = "00000407";
            /// <summary>
            /// زبان انگلیسی عمومی
            /// </summary>
            public const string LANG_EN_US = "00000409";
            public const string LANG_FR_STD = "0000040C";
            public const string LANG_NL_STD = "00000413";
            /// <summary>
            /// زبان فارسی
            /// </summary>
            public const string LANG_PERSIAN = "00000429";
        }
        ...
        [DllImport("user32", EntryPoint = "GetKeyboardLayoutNameA", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
        public static extern int GetKeyboardLayoutName([MarshalAs(UnmanagedType.VBByRefStr)] ref string pwszKLID);
        [DllImport("user32", EntryPoint = "LoadKeyboardLayoutA", CharSet = CharSet.Ansi, SetLastError = true, ExactSpelling = true)]
        public static extern int LoadKeyboardLayout([MarshalAs(UnmanagedType.VBByRefStr)] ref string pwszKLID, int flags);
